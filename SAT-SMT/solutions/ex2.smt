...
(assert (=> p_1_1 (and (not p_2_1) (not p_3_1))))
(assert (=> p_1_2 (and (not p_2_2) (not p_3_2))))
(assert (=> p_1_3 (and (not p_2_3) (not p_3_3))))

(assert (=> p_2_1 (and (not p_1_1) (not p_4_1))))
(assert (=> p_2_2 (and (not p_1_2) (not p_4_2))))
(assert (=> p_2_3 (and (not p_1_3) (not p_4_3))))

(assert (=> p_3_1 (and (not p_1_1) (not p_4_1) (not p_5_1))))
(assert (=> p_3_2 (and (not p_1_2) (not p_4_2) (not p_5_2))))
(assert (=> p_3_3 (and (not p_1_3) (not p_4_3) (not p_5_3))))

(assert (=> p_4_1 (and (not p_2_1) (not p_3_1) (not p_5_1) (not p_6_1))))
(assert (=> p_4_2 (and (not p_2_2) (not p_3_2) (not p_5_2) (not p_6_2))))
(assert (=> p_4_3 (and (not p_2_3) (not p_3_3) (not p_5_3) (not p_6_3))))

(assert (=> p_5_1 (and (not p_3_1) (not p_4_1) (not p_6_1))))
(assert (=> p_5_2 (and (not p_3_2) (not p_4_2) (not p_6_2))))
(assert (=> p_5_3 (and (not p_3_3) (not p_4_3) (not p_6_3))))

(assert (=> p_6_1 (and (not p_4_1) (not p_5_1))))
(assert (=> p_6_2 (and (not p_4_2) (not p_5_2))))
(assert (=> p_6_3 (and (not p_4_3) (not p_5_3))))
